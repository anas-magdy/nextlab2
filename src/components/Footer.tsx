    ...
    <footer className="bg-white border-t border-gray-100">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-gray-900">{t('links')}</h4>
            <div className="flex flex-col space-y-3">
              <Link 
                href={`/${locale}`} 
                className="text-gray-600 hover:text-indigo-600 transition-colors flex items-center group"
              >
                <span className="w-1.5 h-1.5 bg-indigo-600 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                {t('home')}
              </Link>
              <Link 
                href={`/${locale}/users`} 
            ...
            <form className="space-y-3">
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-4 py-2 text-gray-700 bg-gray-50 border border-gray-200 rounded-l-lg focus:outline-none focus:border-indigo-500"
                />
                <button
                  type="submit"
                  className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-r-lg hover:from-indigo-600 hover:to-purple-700 transition-all"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="pt-8 mt-8 border-t border-gray-100">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-600 text-sm">
              {t('copyright')} © {currentYear} NextGen Hub. All rights reserved.
            </p>
